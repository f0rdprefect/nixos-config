...
}@args:
{
  ...
  #  fileSystems."/home/matt/work/n" = {
  #    device = "//office.raith.de/net";
  #    fsType = "cifs";
  #    options =
  #      let
  ...
  #      in
  #      [
  #        "${automount_opts},credentials=/home/matt/work/.smbcredentials,uid=1000,gid=1000,file_mode=0644,dir_mode=0755,vers=3.0"
  #        "nofail"
  #      ];
  #  };
